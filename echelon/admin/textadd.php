...
$sql = "INSERT IGNORE INTO `penalties` (`id`, `type`, `duration`, `inactive`, `admin_id`, `time_add`, `time_edit`, `time_expire`, `reason`, `keyword`, `client_id`) VALUES ('', 'NOTICE', '0', '0', '0', UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), '0', '". $comment ."', '', $id)";
