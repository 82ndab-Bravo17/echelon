...
$query_rs_clientsearch = sprintf("SELECT * FROM clients WHERE group_bits > '2' ORDER BY %s %s", $xlorderby_rs_clientsearch,$xlorder_rs_clientsearch);
  ...
  <body>
    <div id="wrapper">
      ...
      <table width="100%" class="tabelinhoud">
        <tr>
          <td>
            <form action="admins.php" method="GET" name="search" id="search">
			  <?php if ($modsplus == 1) {	?>
				Moderators and above &nbsp&nbsp<input type = "checkbox" name = "mods" CHECKED >
				<?php }
				else { ?>
				Moderators and above &nbsp&nbsp<input type = "checkbox" name = "mods" >
				<?php }
			  ?>
      ...
      <table width="100%" class="tabeluitleg">
        <tr>
          <td align="center">
            ...
            <br>You are viewing a list of all Admins.
          </td>
        </tr>
      </table>
      <table width="100%" cellspacing="1" cellpadding="1">
        <tr class="tabelkop">
          <td>
            client-id&nbsp;
            <a href="<?php echo $navThisPage; ?>?mods=<?php echo $modstring; ?>&game=<?php echo $game; ?>&orderby=id&order=ASC">
              <img src="../img/asc.gif" alt="ascending" width="11" height="9" border="0" align="absmiddle"></a>
            &nbsp;
            <a href="<?php echo $navThisPage; ?>?mods=<?php echo $modstring; ?>&game=<?php echo $game; ?>&orderby=id&order=DESC">
              <img src="../img/desc.gif" alt="descending" width="11" height="9" border="0" align="absmiddle"></a>
          </td>
          <td>
            name&nbsp;
            <a href="<?php echo $navThisPage; ?>?mods=<?php echo $modstring; ?>&game=<?php echo $game; ?>&orderby=name&order=ASC">
              <img src="../img/asc.gif" alt="ascending" width="11" height="9" border="0" align="absmiddle"></a>
            &nbsp;
            <a href="<?php echo $navThisPage; ?>?mods=<?php echo $modstring; ?>&game=<?php echo $game; ?>&orderby=name&order=DESC">
              <img src="../img/desc.gif" alt="descending" width="11" height="9" border="0" align="absmiddle"></a>
          </td>
          <td>
            level&nbsp;
            <a href="<?php echo $navThisPage; ?>?mods=<?php echo $modstring; ?>&game=<?php echo $game; ?>&orderby=group_bits&order=ASC">
              <img src="../img/asc.gif" alt="ascending" width="11" height="9" border="0" align="absmiddle"></a>
            &nbsp;
            <a href="<?php echo $navThisPage; ?>?mods=<?php echo $modstring; ?>&game=<?php echo $game; ?>&orderby=group_bits&order=DESC">
              <img src="../img/desc.gif" alt="descending" width="11" height="9" border="0" align="absmiddle"></a>
          </td>
          <td>
            connections&nbsp;
            <a href="<?php echo $navThisPage; ?>?mods=<?php echo $modstring; ?>&game=<?php echo $game; ?>&orderby=connections&order=ASC">
              <img src="../img/asc.gif" alt="ascending" width="11" height="9" border="0" align="absmiddle"></a>
            &nbsp;
            <a href="<?php echo $navThisPage; ?>?mods=<?php echo $modstring; ?>&game=<?php echo $game; ?>&orderby=connections&order=DESC">
              <img src="../img/desc.gif" alt="descending" width="11" height="9" border="0" align="absmiddle"></a>
          </td>
          <td>
            firstseen&nbsp;
            <a href="<?php echo $navThisPage; ?>?mods=<?php echo $modstring; ?>&game=<?php echo $game; ?>&orderby=time_add&order=ASC">
              <img src="../img/asc.gif" alt="ascending" width="11" height="9" border="0" align="absmiddle"></a>
            &nbsp;
            <a href="<?php echo $navThisPage; ?>?mods=<?php echo $modstring; ?>&game=<?php echo $game; ?>&orderby=time_add&order=DESC">
              <img src="../img/desc.gif" alt="descending" width="11" height="9" border="0" align="absmiddle"></a>
          </td>
          <td>
            lastseen&nbsp;
            <a href="<?php echo $navThisPage; ?>?mods=<?php echo $modstring; ?>&game=<?php echo $game; ?>&orderby=time_edit&order=ASC">
              <img src="../img/asc.gif" alt="ascending" width="11" height="9" border="0" align="absmiddle"></a>
            &nbsp;
            <a href="<?php echo $navThisPage; ?>?mods=<?php echo $modstring; ?>&game=<?php echo $game; ?>&orderby=time_edit&order=DESC">
              <img src="../img/desc.gif" alt="descending" width="11" height="9" border="0" align="absmiddle"></a>
          </td>
        </tr>
        <?php do { ?>
        <tr class="tabelinhoud">
          <td>
            ...
            <td <?php if (strlen(trim($row_rs_clients['name']))==0) { // special case where the player's name is only composed of blank characters  
              ...
              <a href="../clientdetails.php?mods=<?php echo $modstring; ?>&game=<?php echo $game; ?>&id=<?php echo $row_rs_clients['id']; ?>">
                <?php 
